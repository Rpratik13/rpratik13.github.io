...
function LeetcodeIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden="true">
      <path d="M13.48 0a1.37 1.37 0 0 0-.96.42L7.05 6.09 3.4 9.86a5.35 5.35 0 0 0 0 7.44l3.65 3.77 5.47 5.67a1.37 1.37 0 0 0 1.95-1.92l-5.47-5.67a2.61 2.61 0 0 1 0-3.61l3.65-3.77 5.47-5.67A1.37 1.37 0 0 0 13.48 0Z" opacity=".55" />
    ...
    <div className={className}>
      {links.map(({ label, href, Icon }) => (
        <a
          ...
          aria-label={label}
          className="group inline-flex h-11 w-11 items-center justify-center rounded-xl border border-border bg-card text-muted-foreground transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/60 hover:text-primary hover:shadow-[0_0_0_4px_color-mix(in_oklch,var(--primary)_12%,transparent)]"
        >
